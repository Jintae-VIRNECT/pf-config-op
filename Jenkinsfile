            ...
            parallel {
                stage('Develop Branch') {
                    ...
                    steps {
                        ...
                        sh 'docker run -p 6383:6383 --restart=always -d --name=pf-config pf-config'
                                    ...
                                    publishers: [
                                        sshPublisherDesc(
                                            ...
                                            transfers: [
                                                ...
                                                sshTransfer(
                                                    execCommand: "docker run -p 6383:6383 --restart=always -d --name=pf-config $aws_ecr_address/pf-config:\\${GIT_TAG}"
                                                ),
                                                sshTransfer(
